      ...
      {stats && (
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { label: 'Review Withdrawals', href: '/admin/withdrawals', badge: stats.pendingWithdrawals, color: 'text-orange-400 border-orange-500/30 hover:bg-orange-500/10' },
              { label: 'Review KYC', href: '/admin/kyc', badge: stats.pendingKyc, color: 'text-yellow-400 border-yellow-500/30 hover:bg-yellow-500/10' },
              { label: 'Manage Users', href: '/admin/users', badge: null, color: 'text-blue-400 border-blue-500/30 hover:bg-blue-500/10' },
            ].map(({ label, href, badge, color }) => (
              <a
                key={href}
                href={href}
                className={`flex items-center justify-between px-5 py-4 rounded-xl border bg-gray-900 transition-colors ${color}`}
              >
